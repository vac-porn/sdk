...
enum class EInteractionType : uint8_t
{
	...
	EInteractionType__Tank         = 20,
	EInteractionType__Craft        = 21,
	EInteractionType__Uncraft      = 22,
	EInteractionType__Create       = 23,
	EInteractionType__Fix          = 24,
	EInteractionType__FixAll       = 25,
	EInteractionType__Eat          = 26,
	EInteractionType__EatAll       = 27,
	EInteractionType__Drink        = 28,
	EInteractionType__DrinkAll     = 29,
	EInteractionType__CheckTaste   = 30,
	EInteractionType__Equip        = 31,
	EInteractionType__UnEquip      = 32,
	EInteractionType__Cut          = 33,
	EInteractionType__Collect      = 34,
	EInteractionType__LightFire    = 35,
	EInteractionType__AddFuel      = 36,
	EInteractionType__Extinguish   = 37,
	EInteractionType__Prepare      = 38,
	EInteractionType__Cook         = 39,
	EInteractionType__Chop         = 40,
	EInteractionType__SmokeFood    = 41,
	EInteractionType__Destroy      = 42,
	EInteractionType__Store        = 43,
	EInteractionType__TakeInHands  = 44,
	EInteractionType__WashCloth    = 45,
	EInteractionType__WashClothAll = 46,
	EInteractionType__RemoveFromHands = 47,
	EInteractionType__CarryItem    = 48,
	EInteractionType__AddToQuickAccess = 49,
	EInteractionType__RemoveFromQuickAccess = 50,
	EInteractionType__ChamberBullet = 51,
	EInteractionType__LoadAmmo     = 52,
	EInteractionType__UnloadAmmo   = 53,
	EInteractionType__Swap         = 54,
	EInteractionType__Join         = 55,
	EInteractionType__Split        = 56,
	EInteractionType__Unpack       = 57,
	EInteractionType__CheckPulse   = 58,
	EInteractionType__Diagnose     = 59,
	EInteractionType__MakeConscious = 60,
	EInteractionType__ArtificalPerspiration = 61,
	EInteractionType__PullTooth    = 62,
	EInteractionType__PatchWounds  = 63,
	EInteractionType__ImmobilizeLimbs = 64,
	EInteractionType__MendBones    = 65,
	EInteractionType__TreatSickness = 66,
	EInteractionType__PerformLocalAnesthesia = 67,
	EInteractionType__PerformGeneralAnesthesia = 68,
	EInteractionType__PerformSurgery = 69,
	EInteractionType__RevivePatient = 70,
	EInteractionType__InviteToSquad = 71,
	EInteractionType__RemoveFromSquad = 72,
	EInteractionType__LeaveSquad   = 73,
	EInteractionType__Urinate      = 74,
	EInteractionType__Defecate     = 75,
	EInteractionType__Vomit        = 76,
	EInteractionType__CheckTime    = 77,
	EInteractionType__BindHands    = 78,
	EInteractionType__TightenBinds = 79,
	EInteractionType__RemoveBinds  = 80,
	EInteractionType__LoosenBinds  = 81,
	EInteractionType__BreakBinds   = 82,
	EInteractionType__Bury         = 83,
	EInteractionType__UnBury       = 84,
	EInteractionType__Rest         = 85,
	EInteractionType__SitOnGround  = 86,
	EInteractionType__LayOnGround  = 87,
	EInteractionType__ExamineInventory = 88,
	EInteractionType__GestureShowFinger = 89,
	EInteractionType__GestureStandSurrender = 90,
	EInteractionType__GestureWaveHi = 91,
	EInteractionType__GestureYouAreDead = 92,
	EInteractionType__GestureFY    = 93,
	EInteractionType__GesturePoint = 94,
	EInteractionType__GestureHeart = 95,
	EInteractionType__GestureBallpalm = 96,
	EInteractionType__GestureFacepalm = 97,
	EInteractionType__GestureFingerGun = 98,
	EInteractionType__GestureLaughing = 99,
	EInteractionType__GestureSmellWave = 100,
	EInteractionType__GestureSquat = 101,
	EInteractionType__GestureCharge = 102,
	EInteractionType__GestureFreeze = 103,
	EInteractionType__GestureGetDown = 104,
	EInteractionType__GestureGetUp = 105,
	EInteractionType__GestureHalt  = 106,
	EInteractionType__GestureHurryUp = 107,
	EInteractionType__GesturePointMe = 108,
	EInteractionType__GesturePointYou = 109,
	EInteractionType__GestureRally = 110,
	EInteractionType__GestureThumbsUp = 111,
	EInteractionType__GestureThumbsDown = 112,
	EInteractionType__GestureUnderstandNot = 113,
	EInteractionType__GestureUnderstandYes = 114,
	EInteractionType__PlayInstrument = 115,
	EInteractionType__Whistle      = 116,
	EInteractionType__MakeUnconscious = 117,
	EInteractionType__CutHair      = 118,
	EInteractionType__CutFacialHair = 119,
	EInteractionType__PacifyAnimal = 120,
	EInteractionType__TameAnimal   = 121,
	EInteractionType__LearnAnimal  = 122,
	EInteractionType__CommandAnimal = 123,
	EInteractionType__FeedAnimal   = 124,
	EInteractionType__Buy          = 125,
	EInteractionType__Maintain     = 126,
	EInteractionType__Lockpick     = 127,
	EInteractionType__RemoveLocks  = 128,
	EInteractionType__AddUpgrade   = 129,
	EInteractionType__RadioTurnOn  = 130,
	EInteractionType__RadioTurnOff = 131,
	EInteractionType__RadioIncreaseVolume = 132,
	EInteractionType__RadioDecreaseVolume = 133,
	EInteractionType__StackAdd     = 134,
	EInteractionType__StackRemove  = 135,
	EInteractionType__RepairBaseElement = 136,
	EInteractionType__RepairBaseElementArea = 137,
	EInteractionType__RepairBaseElementQuality = 138,
	EInteractionType__ClaimBase    = 139,
	EInteractionType__ShowBaseFlagInfluence = 140,
	EInteractionType__OpenContainer = 141,
	EInteractionType__ChangeItemText = 142,
	EInteractionType__CommitItemText = 143,
	EInteractionType__TurnOn       = 144,
	EInteractionType__TurnOff      = 145,
	EInteractionType__AddProximityTrigger = 146,
	EInteractionType__AddLaserTrigger = 147,
	EInteractionType__AddTripwireTrigger = 148,
	EInteractionType__RemoveTrigger = 149,
	EInteractionType__ShowTrigger  = 150,
	EInteractionType__ArmTrap      = 151,
	EInteractionType__DisarmTrap   = 152,
	EInteractionType__BuryTrap     = 153,
	EInteractionType__UnburyTrap   = 154,
	EInteractionType__EInteractionType_MAX = 155
};
...
enum class EWeaponActionNotifyType : uint8_t
{
	...
	EWeaponActionNotifyType__EWeaponActionNotifyType_MAX = 9
};
...
enum class EPlacementAllowedStatus : uint8_t
{
	...
	EPlacementAllowedStatus__NotAllowedLineTraceFailed = 2,
	EPlacementAllowedStatus__NotAllowedNormalTestFailed = 3,
	EPlacementAllowedStatus__NotAllowedInteractionDistance = 4,
	EPlacementAllowedStatus__NotAllowedWater = 5,
	EPlacementAllowedStatus__NotAllowedAngle = 6,
	EPlacementAllowedStatus__NotAllowedMeshOverlap = 7,
	EPlacementAllowedStatus__NotAllowedTopOverlap = 8,
	EPlacementAllowedStatus__NotAllowedBottomOverlap = 9,
	EPlacementAllowedStatus__NotAllowedExtendedOverlap = 10,
	EPlacementAllowedStatus__NotAllowedTeleportSpot = 11,
	EPlacementAllowedStatus__NotAllowedHitCharacter = 12,
	EPlacementAllowedStatus__NotAllowedHitItem = 13,
	EPlacementAllowedStatus__NotAllowedHitVehicle = 14,
	EPlacementAllowedStatus__NotAllowedNotSnapping = 15,
	EPlacementAllowedStatus__NotAllowedCantPlaceAtLocation = 16,
	EPlacementAllowedStatus__NotAllowedEnemyFlag = 17,
	EPlacementAllowedStatus__NotAllowedTwoPointsConstaints = 18,
	EPlacementAllowedStatus__NotAllowedPlacedDistance = 19,
	EPlacementAllowedStatus__NotAllowedUnknown = 20,
	EPlacementAllowedStatus__EPlacementAllowedStatus_MAX = 21
};
...
// Enum ConZ.FRepairType
enum class EFRepairType : uint8_t
{
	FRepairType__None              = 0,
	FRepairType__RepairHealth      = 1,
	FRepairType__RepairQuality     = 2,
	FRepairType__FRepairType_MAX   = 3
};
...
struct FPawnCharacterInfo
{
	...
	float                                              PoiCharacterIdleThresholdTime;                            // 0x0008(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              ExteriorCharacterIdleThresholdTime;                       // 0x000C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              InteriorCharacterIdleThresholdTime;                       // 0x0010(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              MinShortRangeSpawnDistance;                               // 0x0014(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              MaxShortRangeSpawnDistance;                               // 0x0018(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              MinLongRangeSpawnDistance;                                // 0x001C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              MaxLongRangeSpawnDistance;                                // 0x0020(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              PawnCullDuration;                                         // 0x0024(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                MaxWildCharactersPerPawnGroup;                            // 0x0028(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                MaxExteriorCharactersPerPawnGroup;                        // 0x002C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                MaxInteriorCharactersPerPawnGroup;                        // 0x0030(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              PawnFieldOfView;                                          // 0x0034(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              SpawningFieldOfView;                                      // 0x0038(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                MaxAllowedPawns;                                          // 0x003C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                MaxAllowedWildPawns;                                      // 0x0040(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0xC];                                       // 0x0044(0x000C) MISSED OFFSET
	int                                                MaxAllowedExteriorPawns;                                  // 0x0050(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0xC];                                       // 0x0054(0x000C) MISSED OFFSET
	int                                                MaxAllowedInteriorPawns;                                  // 0x0060(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0xC];                                       // 0x0064(0x000C) MISSED OFFSET
	TArray<struct FSpawnedPawnInfo>                    SpawnedPawns;                                             // 0x0070(0x0010) (ZeroConstructor)
};
...
struct FConZBaseElementDescription
{
	...
	float                                              Quality;                                                  // 0x0158(0x0004) (ZeroConstructor, IsPlainOldData)
